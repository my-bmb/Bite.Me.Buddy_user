...
# ============================================
# ✅ AUTHENTICATION ROUTES - SUPABASE (UPDATED WITH LOCATION DATA HANDLING)
# ============================================
...
def register():
    if request.method == 'POST':
        ...
        try:
            ...
            # Prepare user data with location fields
            user_data = {
...
# ============================================
# ✅ CHECKOUT & ORDERS ROUTES (UPDATED WITH LOCATION COORDINATES)
# ============================================
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            if delivery_latitude and delivery_longitude:
                try:
                    order_data['delivery_latitude'] = float(delivery_latitude)
                    order_data['delivery_longitude'] = float(delivery_longitude)
                    print(f"✅ [CHECKOUT] Added delivery coordinates to order")
                except ValueError:
