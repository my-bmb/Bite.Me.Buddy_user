...
# ✅ FIREBASE ADMIN IMPORT ADDED - CORRECTED
from firebase_service import initialize_firebase_admin  # ✅ CORRECT IMPORT
...
# ✅ FIREBASE ADMIN INITIALIZATION - ADDED
initialize_firebase_admin()  # ADDED
...
def verify_otp():
    ...
    try:
        ...
        try:
            ...
            session['otp_mobile'] = phone_number
            ...
            return jsonify({'success': False, 'message': str(auth_error)})
...
def reset_password():
    ...
    try:
        ...
        if not session.get('otp_verified') or session.get('otp_mobile') != mobile:
