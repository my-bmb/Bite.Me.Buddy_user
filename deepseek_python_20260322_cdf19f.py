# app.py - UPDATED WITH CORRECT ROUTE NAMES (NO DELETIONS)
import os
...
# ============================================
# ✅ FIXED SUPABASE HELPER FUNCTIONS - Supabase v2.0+ COMPATIBLE
# ============================================
...
# ✅ UPDATED: /services route remains same (no change)
@app.route('/services')
@login_required
def services():
    try:
...
# ============================================
# ✅ MENU CATEGORIES SYSTEM - UPDATED ROUTE NAMES
# ============================================

# ✅ UPDATED: Changed from /menu-categories to /menu (main menu page)
@app.route('/menu')
@login_required
def menu():
    """Display all menu categories with their photos"""
    try:
...
# ✅ UPDATED: This route remains same - /menu-category
        ...
        for item in menu_items:
            if not item.get('photo') or item['photo'] == '':
                try:
                    ...
                    print(f"Cloudinary error for {item['name']}: {e}")
                    item['photo'] = "https://res.cloudinary.com/demo/image/upload/v1633427556/sample_food.jpg"
...
# ✅ UPDATED: This route remains same - /menu-item
...
def menu_item_details(item_id):
    ...
    try:
        ...
        print(f"❌ Error loading menu details: {e}")
        flash('Error loading menu details', 'error')
        return redirect(url_for('menu'))

# ============================================
# ✅ SERVICES CATEGORIES SYSTEM - UPDATED ROUTE NAMES
# ============================================

# ✅ UPDATED: Changed from /service-categories to /service (main services page)
@app.route('/service')
@login_required
def service():
    """Display all service categories with their photos"""
    try:
        ...
        return render_template('service.html', categories=categories)
        
    except Exception as e:
        print(f"❌ Error loading service categories: {e}")
        flash('Error loading services', 'error')
        return render_template('service.html', categories=[])

# ✅ UPDATED: This route remains same - /service-category
...
def service_category_items(category_id):
    ...
    try:
        ...
        for service in services_list:
            if not service.get('photo') or service['photo'] == '':
                try:
                    ...
                    print(f"Cloudinary error for {service['name']}: {e}")
                    service['photo'] = "https://res.cloudinary.com/demo/image/upload/v1633427556/sample_service.jpg"
        ...
        print(f"❌ Error loading category services: {e}")
        flash('Error loading services', 'error')
        return redirect(url_for('service'))

# ✅ UPDATED: This route remains same - /service-detail
