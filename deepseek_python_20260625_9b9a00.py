...
# ✅ FIXED: update_location now uses session-based user_id instead of current_user.id
# ✅ FIXED: get_live_messages now has global live_chat_cache declaration
...
def get_live_messages(limit=20, offset=0, from_cache=False):
    ...
    global live_chat_cache  # ✅ Add this line
