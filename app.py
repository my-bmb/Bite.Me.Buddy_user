...
# ============================================
# ✅ TRENDING ITEMS FUNCTION - UPDATED WITH PROPER DATE HANDLING
# ============================================
            ...
            if order.get('items'):
                try:
                    ...
                    if isinstance(items, str):
                        ...
                        print(f"  📦 Parsed JSON string for order {order.get('order_id')}")
                    ...
                    if not isinstance(items, list):
                        print(f"  ⚠️ Unexpected items type: {type(items)} for order {order.get('order_id')}")
                        continue
