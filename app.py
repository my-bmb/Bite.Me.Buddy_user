...
# ✅ ADDED: format_ist_time Jinja2 filter (fixes referral page crash)
...
# ============================================
# ✅ REFERRAL REWARD FUNCTION (FIXED: added logging & correct transaction insert)
# ============================================
...
def process_referral_reward(user_id, amount_spent):
    ...
    try:
        ...
        print(f"💰 Updating total_spent for user {user_id}: {current_total} → {new_total}")
        ...
        if new_total >= 1000 and not user.get('reward_given', False):
            ...
            if referral_mobile:
                ...
                if referrers:
                    ...
                    # Log reward transaction (fixed: all NOT NULL columns)
                    reward_log = {
                        'id': str(uuid.uuid4()),
            ...
            print(f"ℹ️ User {user_id} total_spent={new_total}, reward_given={user.get('reward_given', False)} - condition not met")
