# app.py - COMPLETE UPDATED VERSION WITH ACTIVE_PAGE FOR ALL ROUTES
import os
...
# ============================================
# ✅ MAIN PAGES ROUTES - WITH ACTIVE_PAGE
# ============================================
...
# ============================================
# ✅ SERVICES SYSTEM - UPDATED WITH HIERARCHY + ACTIVE_PAGE
# ============================================
...
def services():
    ...
    try:
        ...
        return render_template('services.html', collections=[], active_page="services")
...
# ============================================
# ✅ MENU SYSTEM - UPDATED WITH HIERARCHY + ACTIVE_PAGE
# ============================================
...
def menu():
    ...
    try:
        ...
        return render_template('menu.html', collections=[], active_page="menu")
...
def cart():
    try:
        ...
        return render_template('cart.html', cart_items=cart_items, total_amount=total_amount, active_page="cart")
    except Exception as e:
        print(f"❌ Cart error: {e}")
        flash(f'Error loading cart: {str(e)}', 'error')
        return render_template('cart.html', cart_items=[], total_amount=0, active_page="cart")
...
def order_history():
    try:
        ...
        return render_template('orders.html', orders=orders_list or [], active_page="orders")
        
    except Exception as e:
        print(f"❌ [ORDER_HISTORY ERROR] {str(e)}")
        traceback.print_exc()
        flash(f'Error loading order history: {str(e)}', 'error')
        return render_template('orders.html', orders=[], active_page="orders")
...
def addresses():
    ...
    try:
        ...
        return render_template('addresses.html', addresses=addresses_list, active_page="profile")
    except Exception as e:
        flash(f'Error loading addresses: {str(e)}', 'error')
        return render_template('addresses.html', addresses=[], active_page="profile")
...
def notifications():
    ...
    try:
        ...
        return render_template('notifications.html', notifications=notifications_list, active_page="profile")
    except Exception as e:
        flash(f'Error loading notifications: {str(e)}', 'error')
        return render_template('notifications.html', notifications=[], active_page="profile")
