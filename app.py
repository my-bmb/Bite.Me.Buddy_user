...
# Profile time formatting from app36.py
...
# ============================================
# ✅ TIMEZONE HELPER FUNCTIONS (COMBINED)
# ============================================
        ...
        try:
            ...
            if users and len(users) > 0:
                ...
                if check_password_hash(user['password'], password):
                    ...
                    # ✅ FROM app36.py: Profile time formatting
...
def order_history():
    try:
        ...
        for index, order in enumerate(orders_data):
            ...
            # ✅ FROM app37.py: Proper UTC to IST conversion with debug
...
# ============================================
# ✅ PROFILE ROUTES - SUPABASE (FROM app36.py)
# ============================================
