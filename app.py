# app.py - COMPLETE UPDATED VERSION WITH BOTH MENU & SERVICES CATEGORY SYSTEMS
import os
...
# ============================================
# ✅ SERVICES SYSTEM - UPDATED (Now shows service categories)
# ============================================
...
# ============================================
# ✅ MENU SYSTEM - UPDATED (Now shows menu categories)
# ============================================
...
def cart():
    try:
        ...
        for item in cart_items_db:
            ...
            # Get photo from Cloudinary if not in DB
            photo_url = db_photo
