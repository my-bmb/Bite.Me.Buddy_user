...
# ✅ FIXED PROFILE PICTURE UPLOAD ROUTE - CORRECT TRANSFORMATION FORMAT
@app.route('/upload-profile-pic', methods=['POST'])
@login_required
def upload_profile_pic():
    """Upload profile picture to Cloudinary - FIXED TRANSFORMATION ERROR"""
        ...
        if 'profile_pic' in request.files:
            ...
            if file and file.filename and allowed_file(file.filename):
                try:
                    ...
                    # ✅ FIXED: CORRECT TRANSFORMATION FORMAT
