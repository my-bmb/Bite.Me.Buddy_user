...
# ============================================
# ✅ ORDER HISTORY ROUTE (FIXED CUSTOMER ORDER NUMBERING)
# ============================================
    ...
    try:
        with get_db_connection() as conn:
            with conn.cursor() as cur:
                ...
                # ✅ FIXED: Calculate customer order numbers correctly
                total_orders = len(orders_data)
                
                for index, order in enumerate(orders_data):
                    # ✅ FIXED: Customer order number = total_orders - index
                    # Latest order (index=0) → Order #total_orders
                    # Oldest order (last index) → Order #1
                    ...
                    orders_list.append({
                        ...
                        'order_no': customer_order_no,  # ✅ User-friendly number
...
# ============================================
# ✅ ORDER DETAILS ROUTE (FIXED CUSTOMER ORDER NUMBERING)
# ============================================
    ...
    try:
        with get_db_connection() as conn:
            with conn.cursor() as cur:
                ...
                """, (session['user_id'],))  # ✅ सिर्फ current user
                ...
                if all_user_orders:
                    print(f"  All orders for this user:")
                    for idx, o in enumerate(all_user_orders):
                        print(f"    {idx+1}. Order ID: {o['order_id']}, Date: {o['order_date']}")
