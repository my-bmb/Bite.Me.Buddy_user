...
def logout():
    ...
    logout_user()
    session.clear()  # Clear all session data (will remove location etc.)
...
def handle_send_message(data):
    ...
    logger.info(f"📩 PRIVATE MESSAGE: from={user_id} to={receiver_id} content='{content_preview}...' sid={sid}")
    ...
    if message:
        logger.info(f"✅ MESSAGE SAVED: id={message['id']} from={user_id} to={receiver_id}")
        msg_dict = {
            'id': message['id'],
...
# ============================================
# ✅ FIXED: edit_message route - session-based (already fixed above)
# ============================================

# The route '/edit_message' is already defined above with session-based logic.
# We'll keep the existing definition from earlier (the one that uses current_user.id).

# ============================================
# ✅ FIXED: delete_message route - session-based (already fixed above)
# ============================================

# The route '/delete_message/<message_id>' is already defined above with session-based logic.

# ============================================
# ✅ FIXED: react_to_message route - session-based (already fixed above)
# ============================================

# The route '/react_to_message' is already defined above with session-based logic.

# ============================================
# ✅ FIXED: upload and upload_audio routes - session-based (already fixed above)
# ============================================

# These routes are already defined above with session-based logic.
