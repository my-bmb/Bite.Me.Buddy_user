# app.py - COMPLETE UPDATED VERSION WITH USER DASHBOARD (DISCOUNTS + AUTO-SCROLL)
import os
...
# ============================================
# ✅ MAIN PAGES ROUTES - UPDATED DASHBOARD WITH DISCOUNTS
# ============================================

@app.route('/dashboard')
@login_required
def dashboard():
    """User Dashboard - Shows top discounts (services + menu items combined)"""
